...
const AddExpenseDialog = ({ trigger, open, onOpenChange }: AddExpenseDialogProps) => {
  ...
  const dialogOpen = isControlled ? open : isAddDialogOpen;
  const setDialogOpen = isControlled ? onOpenChange : setIsAddDialogOpen;
